...
let Contact = () => {
    ...
    return (
        <><Navbaar />
            ...
            <section className="mb-4" style={{ width: '80%', margin: ' 50px auto' }}>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="md-form mb-0">
                                        ...
                                        <input type="number" id="subject" onChange={(v) => { setphone(v.target.value) }} name="subject" className="form-control" />
                                    </div>
                                </div>
                            </div>
